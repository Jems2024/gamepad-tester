...
const OFFICIAL_OVERLAYS = {
  ...
  'ps5': {
    buttons: {
      ...
      4:  { type: 'rect',   x: 195, y: 220, w: 85, h: 36, rx: 12, color: '#2979ff', name: 'L1: Bumper Izquierdo' },
      5:  { type: 'rect',   x: 720, y: 220, w: 85, h: 36, rx: 12, color: '#2979ff', name: 'R1: Bumper Derecho' },
      6:  { type: 'trigger',x: 210, y: 175, w: 75, h: 46, rx: 14, color: '#ff9100', name: 'L2: Gatillo Izquierdo' },
      7:  { type: 'trigger',x: 715, y: 175, w: 75, h: 46, rx: 14, color: '#ff9100', name: 'R2: Gatillo Derecho' },
      8:  { type: 'pill',   cx: 300, cy: 308, rx: 12, ry: 20, color: '#ffffff', name: 'Create Button' },
      9:  { type: 'pill',   cx: 700, cy: 308, rx: 12, ry: 20, color: '#ffffff', name: 'Options Button' },
  ...
  'ps4': {
    buttons: {
      ...
      4:  { type: 'rect',   x: 205, y: 230, w: 85, h: 40, rx: 12, color: '#2979ff', name: 'L1: Bumper Izquierdo' },
      5:  { type: 'rect',   x: 710, y: 230, w: 85, h: 40, rx: 12, color: '#2979ff', name: 'R1: Bumper Derecho' },
      6:  { type: 'trigger',x: 220, y: 175, w: 75, h: 52, rx: 14, color: '#ff9100', name: 'L2: Gatillo Izquierdo' },
      7:  { type: 'trigger',x: 705, y: 175, w: 75, h: 52, rx: 14, color: '#ff9100', name: 'R2: Gatillo Derecho' },
  ...
  'xbox-series-s': {
    buttons: {
      ...
      4:  { type: 'rect',   x: 188, y: 188, w: 98, h: 44, rx: 12, color: '#00e676', name: 'LB: Left Bumper' },
      5:  { type: 'rect',   x: 714, y: 188, w: 98, h: 44, rx: 12, color: '#00e676', name: 'RB: Right Bumper' },
      6:  { type: 'trigger',x: 198, y: 138, w: 84, h: 50, rx: 14, color: '#ff9100', name: 'LT: Left Trigger' },
      7:  { type: 'trigger',x: 718, y: 138, w: 84, h: 50, rx: 14, color: '#ff9100', name: 'RT: Right Trigger' },
  ...
  'xbox-one': {
    buttons: {
      ...
      4:  { type: 'rect',   x: 200, y: 242, w: 95, h: 40, rx: 12, color: '#00e676', name: 'LB: Left Bumper' },
      5:  { type: 'rect',   x: 705, y: 242, w: 95, h: 40, rx: 12, color: '#00e676', name: 'RB: Right Bumper' },
      6:  { type: 'trigger',x: 215, y: 212, w: 75, h: 30, rx: 10, color: '#ff9100', name: 'LT: Left Trigger' },
      7:  { type: 'trigger',x: 710, y: 212, w: 75, h: 30, rx: 10, color: '#ff9100', name: 'RT: Right Trigger' },
      8:  { type: 'circle', cx: 430, cy: 395, r: 18, color: '#ffffff', name: 'View / Back' },
      9:  { type: 'circle', cx: 570, cy: 395, r: 18, color: '#ffffff', name: 'Menu / Start' },
